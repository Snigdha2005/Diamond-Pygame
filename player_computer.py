...
def get_player_input(screen, font, player1_cards, player_suit, player2_cards, computer_suit):
    selected_card = None
    player_cards = list(all_cards.keys())
    ...
    while True:
        ...
        for i, card in enumerate(player_cards):
            card_rect = pygame.Rect((300 + i * 60, 400, card_width, card_height))
            pygame.draw.rect(screen, GREEN, card_rect, 2)  # Draw card border
            ...
            if card_rect.collidepoint(pygame.mouse.get_pos()):
                ...
                pygame.draw.rect(screen, RED, card_rect, 3)
        for i in player1_cards:
            screen.blit(card_images[player_suit][all_cards[i] - 2], (300+((all_cards[i]-2)*60), 350))
